...
public class StarsLocker : MonoBehaviour
{
    ...
    public void ActivateStars(int level, string selectedPuzzle)
    {
        ...
        {
            case "FruitsPuzzle" :
                stars = fruitPuzzleLevelsStars[level];
                ActivateLevelStars(level, stars);
                break;

            case "AnimalsPuzzle" :
                stars = animalPuzzleLevelsStars[level];
                ActivateLevelStars(level, stars);
                break;            
    ...
    void GetStars()
    {
        fruitPuzzleLevelsStars = puzzleGameSaver.fruitPuzzleLevelsStars;
        animalPuzzleLevelsStars = puzzleGameSaver.animalPuzzleLevelsStars;
